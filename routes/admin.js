...
router.put('/users/:id/approve', [
  ...
  try {
    ...
    // --- FIX IS HERE ---
    // When approving, we set both isApproved and isActive to true.
    // When rejecting (isApproved: false), we also deactivate the account.
    user.isApproved = isApproved;
    user.isActive = isApproved; // This ensures an approved user is always active.
    // --- END OF FIX ---
